...
6. **Permanent Skill Infusion: Zero-Jargon Storytelling, ADHD, Ponytail & Headroom**:
   ...
   - **3-Act Storytelling Chronology**: Every stage turn must follow a chronological story arc formatted **neatly one below the other with blank line separation**, with **3 short, targeted bullet points each** to give full context:
